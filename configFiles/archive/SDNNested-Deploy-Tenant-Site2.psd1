 @{
    ...
    @(
        @{
            ...
            NICs         = @( 
                @{ 
                    Name = "Contoso-NetAdapter"; IPAddress = '172.16.1.12/24'; Gateway = '172.16.1.1'; 
        ...
        @{
            ...
            NICs         = @( 
                @{ 
                    Name = "Contoso-NetAdapter"; IPAddress = '172.16.1.13/24'; Gateway = '172.16.1.1'; 
                    DNS = @("172.16.1.53") ; MACAddress = '00-00-00-00-00-00'; VLANID = 0 
                };
            )   
        },
        @{
            ...
            NICs         = @( 
                @{ 
                    Name = "Fabrikam-NetAdapter"; IPAddress = '172.16.1.12/24'; Gateway = '172.16.1.1'; 
                    DNS = @("172.16.1.53") ; MACAddress = '00-00-00-00-00-00'; VLANID = 0 
                };
            )
        },
        @{
            ...
            NICs         = @( 
                @{ 
                    Name = "Fabrikam-NetAdapter"; IPAddress = '172.16.1.13/24'; Gateway = '172.16.1.1'; 
                    DNS = @("172.16.1.53") ; MACAddress = '00-00-00-00-00-00'; VLANID = 0 
                };
            )   
        }
